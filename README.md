...
| 并发 | QPS | 平均延迟 | P99延迟 | 成功率 |
|------|-----|---------|---------|--------|
| 50 | 328.23 | 146.56ms | 436.91ms | 97.6% |
| 100 | 320.1 | 292.06ms | 1286.31ms | 97.8% |
| 200 | 331.39 | 548.77ms | 1426.36ms | 97.55% |
| 300 | 317.77 | 854.37ms | 3158.08ms | 97.55% |

**说明**: 在 200 并发时达到最佳 QPS (331.39)，P99 延迟控制在 1.5s 以内。

### 批量上传压测

| 并发 | 批次QPS | 图片QPS | 平均延迟 | P99延迟 | 成功率 | 总图片数 |
|------|---------|---------|---------|---------|--------|----------|
| 20 | 27.24 | 335.41 | 712.45ms | 2437.61ms | 100.0% | 3694 |
| 50 | 19.44 | 245.16 | 2303.81ms | 12310.87ms | 100.0% | 3784 |
| 100 | 22.67 | 289.36 | 3611.01ms | 12560.58ms | 100.0% | 3829 |
| 150 | 24.96 | 320.91 | 4376.65ms | 11720.77ms | 99.67% | 3857 |

**说明**: 批量上传在 20 并发时性能最优，单图片 QPS 可达 335.41，适合大批量场景。
